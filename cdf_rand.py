...
import numpy,time,datetime,sys,math,struct,os,subprocess,csv,re,argparse,random
...
class usrpparser:
    ...
    def run(self,args):
        ...
        inputendtime = a.Get_utc(args.end_time)
        inputstarttime = a.Get_utc(args.start_time)
        inputtime = a.Tu_d(random.uniform(inputstarttime, inputendtime))
        if args.m:
